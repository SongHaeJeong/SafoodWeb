	...
	<div>
		...
		<div class="container">
			...
			<div>
				...
				<input type ="text" name ="search" v-model= "data">
			...
			<table class="table text-center table-hover"  >
				...
				<tbody>
					<tr v-for="bod in result">
						...
						<td ><router-link :to="{name	 : 'detailQuestion', params :{qid:bod.qid}}">{{bod.title}}</router-link></td>
						<td v-text="bod.wdate"></td>
						<!-- <td><a @click="modifyRoute(bod.qid)">글수정</a></td> -->
						<td><router-link :to="{name	 : 'updateQuestion', params :{qid:bod.qid}}">글수정</router-link>
